...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, in_channels=1, output_size=2, alpha=2.0, beta=50, base=1.0):
...
def ResNet_size(size=10, in_channels=1, output_size=2, alpha=2.0, beta=50, base=1.0):
    if size == 10:
